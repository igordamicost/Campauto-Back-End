...
import transferOrdersRoutes from "./routes/transferOrders.js";
import preOrdersRoutes from "./routes/preOrders.js";
import salesLogRoutes from "./routes/salesLog.js";
...
import fiscalApiRoutes from "./routes/fiscalApi.js";
...
app.use("/transfer-orders", transferOrdersRoutes);
app.use("/pre-orders", preOrdersRoutes);
app.use("/sales-log", salesLogRoutes);
...
app.use("/api/v1", fiscalApiRoutes);
